...
const std::vector<Vertex> vertices = {
	...
	{{-1.0f, -1.0f, 0.5f}, {1.0f, 0.0f, 0.0f, 0.5f}, {1.0f, 0.0f}},
	{{-0.75f, -1.0f, 0.5f}, {0.0f, 1.0f, 0.0f, 0.5f}, {0.0f, 0.0f}},
	{{-0.75f, -0.75f, 0.5f}, {0.0f, 0.0f, 1.0f, 0.5f}, {0.0f, 1.0f}},
	{{-1.0f, -0.75f, 0.5f}, {1.0f, 1.0f, 1.0f, 0.5f}, {1.0f, 1.0f}}};
...
class HelloTriangleApplication {
  ...
  private:
	...
	void createGraphicsPipeline() {
		auto vertShaderCode = readFile("demo-shaders/vert.spv");
		auto fragShaderCode = readFile("demo-shaders/frag.spv");
